...
export const translations = {
  ...
  ar: {
    meta: {
      siteName: 'أركان هب ون',
      tagline: 'توريدات وحلول كهروميكانيكية',
      description:
        'أركان هب ون شريكك الموثوق في التوريدات والحلول الكهروميكانيكية — كابلات ولوحات توزيع وأنظمة تكييف ومكافحة حريق للمشاريع السكنية والتجارية والصناعية في مصر.',
      keywords: [
    ...
    hero: {
      ...
      subtitle:
        'من الكابلات ولوحات التوزيع إلى أنظمة التكييف ومكافحة الحريق — أركان هب ون يوفّر العمود الفقري الكهروميكانيكي لمشروعك.',
    ...
    values: {
      ...
      subtitle:
        'كل قرار في أركان هب ون ينبع من خمس قيم تشكّل طريقة توريدنا وتسليمنا ودعمنا.',
      items: [
        {
          title: 'بناء الثقة',
    ...
    whyPartner: {
      ...
      title: 'لماذا تختار فرق العمل أركان هب ون',
      subtitle:
    ...
    contact: {
      eyebrow: 'تواصل معنا',
      title: 'تحدّث مع فريق أركان هب ون',
      subtitle:
    ...
    about: {
      eyebrow: 'عن أركان هب ون',
      title: 'اسم جديد، مبنيّ على فهم عميق للسوق',
      lead: 'أركان هب ون شركة ناشئة شريكة في التوريدات والحلول الكهروميكانيكية الشاملة. ورغم حداثة تأسيسنا، نعمل بشغف والتزام بالتميّز، وفهم متين لسوق المواد الكهروميكانيكية.',
      body: [
